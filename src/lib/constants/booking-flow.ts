...
export const BOOKING_FLOW_MIN_HOURS_BEFORE_SESSION = 25;
...
export const BOOKING_FLOW_MESSAGES = {
  ...
  minimumLeadTime: `Sessions must be booked at least ${BOOKING_FLOW_MIN_HOURS_BEFORE_SESSION} hours in advance.`,
  ...
  slotTooSoon: `This slot is too close to the start time. Sessions must be booked at least ${BOOKING_FLOW_MIN_HOURS_BEFORE_SESSION} hours in advance.`,
